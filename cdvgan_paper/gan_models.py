    ...
    def train_step(self, data):
        ...
        for i in range(self.d_steps):
            ...
            with tf.GradientTape(persistent=True) as tape:
                ...
                print("Shape of fake_derivatives:", tf.shape(fake_derivatives))
        ...
        with tf.GradientTape() as tape:
            ...
            generated_derivatives = calculate_derivative(tf.cast(np.array(range(256)), tf.float32), generated_signals)
    ...
    def train_step(self, data):
        ...
        for i in range(self.d_steps):
            ...
            with tf.GradientTape(persistent=True) as tape:
                ...
                fake_derivatives = calculate_derivative(tf.cast(np.array(range(256)), tf.float32), fake_signals)
                fake_derivatives2 = calculate_derivative(tf.cast(np.array(range(255)), tf.float32), fake_derivatives)
        ...
        with tf.GradientTape() as tape:
            ...
            generated_derivatives = calculate_derivative(tf.cast(np.array(range(256)), tf.float32), generated_signals)
            generated_derivatives2 = calculate_derivative(tf.cast(np.array(range(255)), tf.float32), generated_derivatives)
